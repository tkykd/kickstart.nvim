...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.diagnostic.config {
        ...
        float = {
          source = 'if_many',
          border = 'rounded',
        }, -- Show diagnostic in a floating window instead of inline
      }
      vim.api.nvim_set_keymap('n', 'gh', ':lua vim.diagnostic.open_float()<CR>', { noremap = true, silent = true })
      ...
      local picker_venv = require 'kickstart.plugins.picker_venv'
      local servers = {
        -- clangd = {},
        -- gopls = {},
        pyright = {
          before_init = function(_, config)
            config.settings.python.pythonPath = picker_venv.get_python_path(config.root_dir)
          end,
        },
        -- rust_analyzer = {},
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'python', 'go', 'javascript', 'dockerfile' },
  ...
  -- require 'kickstart.plugins.neo-tree', -- use nvim-tree instead
